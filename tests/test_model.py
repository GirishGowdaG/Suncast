...
def sample_data():
    ...
    data = {
        ...
        "irradiance": [0, 0, 0, 0, 0, 0, 100, 300, 500, 700, 850, 950,
                       1000, 950, 850, 700, 500, 300, 100, 0, 0, 0, 0, 0],
        "temp": [15, 14, 14, 13, 13, 14, 16, 19, 22, 25, 27, 29,
                 30, 29, 28, 26, 23, 20, 18, 16, 15, 15, 14, 14],
        "wind_speed": [2.1, 1.8, 1.5, 1.3, 1.2, 1.4, 2.0, 2.5, 3.1, 3.5, 3.8, 4.0,
                       3.9, 3.7, 3.4, 3.0, 2.7, 2.3, 2.0, 1.8, 1.7, 1.9, 2.0, 2.1],
        "pv_output": [0, 0, 0, 0, 0, 0, 18, 54, 90, 126, 153, 171,
                      180, 171, 153, 126, 90, 54, 18, 0, 0, 0, 0, 0],
    }
